...
try {
  // الكود الذي يحتوي على الكود الذي يرمي الاستثناء
} catch (InvalidArgumentException $e) {
  echo 'Error: ' . $e->getMessage();
  // يمكنك أيضًا إجراء أي إجراءات إضافية هنا، مثل إعادة توجيه المستخدم أو عرض رسالة خطأ أخرى
}
try{
...
if (isset($_POST['addExpense']))
 {
    ...
    $category_id = $_GET['id']; // إضافة هذا السطر للحصول على معرف الفئة من العنوان URL
